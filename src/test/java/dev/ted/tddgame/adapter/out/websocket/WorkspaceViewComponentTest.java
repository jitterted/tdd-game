...
class WorkspaceViewComponentTest {
    ...
    void emptyPlayAreaInWorkspaceRenderedAsEmpty() {
        Player player = Player.createForTest(22L, "Player no in-play cards");
    ...
    void playedCardShowsUpInWorkspaceInPlayArea() {
        Player player = Player.createForTest(64L, "Player played card");
    ...
    void emptyTechNeglectAreaInWorkspaceRenderedAsEmpty() {
        Player player = Player.createForTest(23L, "Player no Tech Neglect cards");
    ...
    void twoCardsInTechNeglectAreaInWorkspaceRenderedAsTwoCardDivs() {
        Player player = Player.createForTest(IRRELEVANT_PLAYER_ID,
